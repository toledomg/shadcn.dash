            ...
            <div className="space-y-8">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-6xl">
                  ...
                  <span className="flex justify-center sm:inline-flex">
                    <span className="relative mx-2">
                      ...
                      <div className="from-primary/30 to-secondary/30 absolute start-0 -bottom-2 h-1 w-full bg-gradient-to-r" />
                    </span>
                    today
                  </span>
                </h1>
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row sm:gap-6">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="group cursor-pointer px-8 py-6 text-lg font-medium"
                  asChild
                >
                  <a
